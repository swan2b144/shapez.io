...
export class ShapeDefinition extends BasicSerializableObject {
    ...
    drawCentered(x, y, parameters, diameter = 20) {
        ...
        } else if (!this.bufferGenerator && visibleDisplayMod) {
            this.bufferGenerator = this.internalGenerateShapeBufferJustForDisplayMod.bind(this);
        }
     ...
     * @param {number} dpi
     */
    internalGenerateShapeBufferJustForDisplayMod(canvas, context, w, h, dpi) {
