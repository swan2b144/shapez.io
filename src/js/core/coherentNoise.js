...
export class CoherentNoise {
    ...
    /**
     * sets sets the global scale for
     * @param {number} scale
     */
     ...
     * @returns {number}
     */
    computePerlin2(xRaw, yRaw) {
        var x = xRaw * this.scale;
        var y = yRaw * this.scale;
    ...
    computeSimplex2(xRaw, yRaw) {
        var yin = yRaw * this.scale;
        var xin = xRaw * this.scale;
